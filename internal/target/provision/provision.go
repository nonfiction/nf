...
func compactCloudInitHealthStyle(rendered string) string {
	...
	compact := indent + `body{margin:0;min-height:100vh;display:grid;place-items:center;background:radial-gradient(at 20% 20%,#2a1d4a,#0000 32rem),radial-gradient(at 80% 10%,#230b4b,#0000 28rem),#09090f;color:#f8fafc;font-family:system-ui,sans-serif}main{width:min(92vw,34rem);padding:3rem;border:1px solid #30234f;border-radius:1.75rem;background:#11111ccc;text-align:center}.logo{display:block;width:5.5rem;margin:0 auto 1rem;border-radius:1.25rem}.pill{display:inline-block;margin:0 0 1rem;padding:.35rem .8rem;border-radius:9em;background:#1b2f2d;color:#86efac;font-weight:700}h1{font-size:3rem;margin:.5rem 0}`
